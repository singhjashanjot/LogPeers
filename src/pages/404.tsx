...
const NotFound = () => {
    return (
        <StyledWrapper className="h-screen flex flex-col justify-center items-center">
        ...
        C86.34,11.918,137.664-5.445,189.928,1.502l-3.95,29.738C143.041,25.54,100.895,39.789,70.343,70.343z"
            ...
            <Link
              to="/"
              className="px-2 py-2 bg-black dark:bg-white text-white dark:text-black rounded-lg font-bold transition duration-400 flex overflow-hidden items-center text-sm focus-visible:outline-none border focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 shadow hover:bg-black/90 h-10 max-w-52 whitespace-pre md:flex group relative w-full justify-center gap-2 duration-300 ease-out hover:ring-2 hover:ring-black hover:ring-offset-2 crazyfont"
            >
              Back To Home
            </Link>
        </StyledWrapper>
