        ...
        <div className="z-0 flex min-h-[600px] w-full flex-col items-center justify-center overflow-hidden rounded-lg bg-background md:shadow-xl">
            <div className="mx-auto self-center text-center flex items-center flex-col justify-center gap-5 px-5 mt-auto">
                ...
                <div className="flex flex-col mb-8 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
                    ...
                    <a
                        href="#"
                        className="inline-flex items-center transition ease-out justify-center px-7 py-3 text-base font-medium text-center border border-solid border-neutral-300 shadow-md text-neutral-600 bg-white rounded-full  hover:bg-gray-100 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-300"
                    >
                ...
                <img src="/icons/arrow.gif" className="pointer-events-none" height={10} alt="" />
